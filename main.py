...
def generate_analytical_json(raw_data_prompt):
    ...
    4. КАТЕГОРИЧЕСКИ ИСКЛЮЧАЙ ЛОКАЛЬНУЮ ВНУТРЕННЮЮ ПОЛИТИКУ США И ДРУГИХ СТРАН:
       - ИСКЛЮЧАЙ: праймериз и выборы уровня штатов/городов (например, праймериз в Миннесоте), внутренние межпартийные споры (например, борьба Пелоси за наследие), локальные назначения судебных/юридических чиновников (например, Тодд Бланше), региональные инициативы.
       - РАЗРЕШЕНО ИЗ США: ТОЛЬКО решения, влияющие на весь мир или Россию (внешняя политика, санкции, решения ФРС США, президентские выборы, ключевые решения Белого Дома и Конгресса глобального масштаба).

    5. КАТЕГОРИЧЕСКИ ИСКЛЮЧАЙ: бытовую недвижимость, ремонт дорог, спорт, шоу-бизнес, бытовые ДТП.
    6. Переводи всё на русский язык.
    7. "summary_ru" — суть без скобок и названий источников.
