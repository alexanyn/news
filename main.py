...
def generate_analytical_json(raw_data_prompt):
    ...
    7. КАТЕГОРИЧЕСКИ ИСКЛЮЧАЙ мусор (даже если он про Россию): 
       ...
       - Лайфстайл, спорт.
    8. "summary_ru" — факт + краткий контекст (что это значит. Но не нужно начинать предложение с «что это значит» и использовать «Важно:». Просто обозначение новости). До 220 символов. Переводи на русский.
